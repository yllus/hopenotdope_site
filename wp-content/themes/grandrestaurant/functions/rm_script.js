...
jQuery(document).ready(function(){
	...
	jQuery('#pp_import_content_button').on( 'click', function(){
        ...
        jQuery.post(ajaxurl, data, function(response) {
            jQuery('.import_message').html('<div class="import_message_success">All done. Note: You might want to also <a href="http://themes.themegoods2.com/grandrestaurant_doc/import-demo-revolution-sliders/" target="_blank">import demo Revolution Sliders.</a></div>');
