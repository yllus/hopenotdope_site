	...
	?>
	    <div class="extend_top_contact_info top_contact_info">
	    	<?php
	    	    ...
	    	    {	
	    	?>
	    	    <span id="top_contact_address"><i class="fa fa-map-marker"></i><a href="mailto:<?php echo esc_attr($tg_menu_contact_address); ?>"><?php echo esc_html($tg_menu_contact_address); ?></a></span>
	    	<?php
	    	    }
	    	?>
	    	<?php
